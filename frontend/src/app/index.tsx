...
export default function Welcome() {
  ...
  return <Screen contentStyle={{ paddingTop: 22, justifyContent: 'space-between', gap: 30 }}>
    ...
    <View style={{ gap: 12 }}><Button label="Let's get moving" icon="arrow-forward" onPress={() => router.replace('/home')} /><AppText variant="caption" color={colors.muted} style={{ textAlign: 'center' }}>Try the demo as Ryan. All activity and money are simulated.</AppText></View>
  </Screen>;
}
